 ...
 */
include_once "include/dc_dbpdomysql.php";
class DB_mysql extends dc_dbpdomysql {
    function DB_mysql($host, $database, $user, $password)
    {
            global  $GL_DB_USER, $GL_DB_PASSWORD,$GL_DSNPARAM;
            $this->Dsn =  $GL_DSNPARAM.$GL_DB_NAME;
